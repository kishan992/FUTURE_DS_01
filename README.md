...
* **Customer Segments:** The **Consumer segment** drives 50% of revenue, but the **Corporate segment** shows 15% higher year-over-year growth.
...
<div align="left">
  <video src="https://github.com/kishan992/FUTURE_DS_01/releases/download/v1/dashboard_demo.mp4" width="100%" controls>
  </video>
</div>

[Click here to watch the Video Demo if the player doesn't load](https://github.com/kishan992/FUTURE_DS_01/releases/download/v1/dashboard_demo.mp4)
